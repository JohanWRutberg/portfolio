...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      <div className="rounded-full border border-[#00ff73] h-[200px] w-[200px] absolute mt-52 animate-ping" />
      ...
      <div className="rounded-full border border-[#00ff73] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
